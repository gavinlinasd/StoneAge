...
)
{
	...
	My_Fire = My_Fire * Vs_None * AJ_UP		// 绍     雄中
			+ My_Fire * Vs_Fire * AJ_SAME   // 府  府   圷
			+ My_Fire * Vs_Water * AJ_DOWN  // 府     十嶄
	...
	My_Wind = My_Wind * Vs_None * AJ_UP		 // 氘     雄中
			+ My_Wind  * Vs_Fire * AJ_DOWN   // 覡  府  十嶄
