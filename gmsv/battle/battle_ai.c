...
#define B_AI_NORMAL_ATTACKOPTION	"at"	/*   攻击选项 */
#define B_AI_NORMAL_GUARDOPTION		"gu"	/*   防御选项 */
#define B_AI_NORMAL_MAGICOPTION		"ma"	/* 咒术选项 */
#define B_AI_NORMAL_ESCAPEOPTION	"es"	/*   仆月左皿扑亦件 */
#define B_AI_NORMAL_WAZAOPTION		"wa"	/*   逃跑选项 */
...
static int BATTLE_ai_normal( int turn, int charaindex,
							...
							struct B_AI_RESULT *result)
{
	int		at[B_AI_NORMAL_ATTACKSUBOPTIONNUM] = { 0,0,0}; 		/*   攻击选项 */
	int		gu[B_AI_NORMAL_GUARDSUBOPTIONNUM] = {0}; 		/* 选项 */
	int		ma[B_AI_NORMAL_MAGICSUBOPTIONNUM] = {0}; 		/* 选项 */
	int		es[B_AI_NORMAL_ESCAPESUBOPTIONNUM] = {0}; 			/* 选项 */
	int		wa[B_AI_NORMAL_WAZASUBOPTIONNUM] = {0,0,0,0, 0,0,0};/* 选项 */
#ifdef _ENEMY_ATTACK_AI
