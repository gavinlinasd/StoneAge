...
typedef enum
{
    MAP_WALKABLE,           /*
                             ...
                             * �鷅  M        獗     2
                             */
    MAP_HAVEHEIGHT,         /*  詢            準0           0   */
    MAP_DEFENCE,            /*  �\        ﹜忐掘薯﹜0 眕狟    �\        */

    MAP_INTODAMAGE,         /*        ��    奀  HP  逋  �   */
    MAP_OUTOFDAMAGE,        /*          堤  奀  HP  逋  �   */

    MAP_SETED_BATTLEMAP,    /*             扢隅�  */
	MAP_BATTLEMAP,			/*               楓�A ㄠ*/
	MAP_BATTLEMAP2,			/*               楓�A ㄡ*/
	MAP_BATTLEMAP3,			/*               楓�A ㄢ*/

/* 眕狟  �怗茛�  妏        �茛�    妏      (�  X      �  @) */

    MAP_INTODARKNESS,       /*  ��    奀  做      */
    MAP_INTOCONFUSION,      /*  ��    奀  髦�     */

    MAP_OUTOFPOISON,         /*  ��    奀  馮    */
    MAP_OUTOFPARALYSIS,      /*  ��    奀            */
    MAP_OUTOFSILENCE,        /*  ��    奀  朻�   */
    MAP_OUTOFSTONE,          /*  ��    奀  坒    */
    MAP_OUTOFDARKNESS,       /*  ��    奀  做      */
    MAP_OUTOFCONFUSION,      /*  ��    奀  髦�     */
