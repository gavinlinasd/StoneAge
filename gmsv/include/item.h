...
typedef enum
{
    ...
    ITEM_ATTACKNUM_MIN,             /*    豕  捌者佰  */
    ITEM_ATTACKNUM_MAX,             /*    耄  捌者佰  */
    ...
    ITEM_MODIFYAVOID,               /*  者    弔尋    */
	ITEM_MODIFYATTRIB,				/*  属性修正 */
	ITEM_MODIFYATTRIBVALUE,			/*  属性修正值 */
	ITEM_MAGICID,					/*  热诸  寞 */
	ITEM_MAGICPROB,					/*  热诸       */
...
//	ITEM_BEMERGE,
    ...
    ITEM_STONE,              		/* 檗［垫  匹五卅中              */
    ITEM_DRUNK,              		/* 办丹［      互票互月     */
    ITEM_CONFUSION,          		/* 混乱?攻击目标会出错     */

	ITEM_CRITICAL,					/* 暴击    修正 */

	ITEM_USEACTION,					/* 银匀凶凛及失弁扑亦件 */
    ITEM_DROPATLOGOUT,              /* 登出时是否放下  */
    ITEM_VANISHATDROP,              /*   仄凶凛卞壅尹月井升丹井 */
    ITEM_ISOVERED,                  /*  是否能骑乘?*/
	ITEM_CANPETMAIL,				/* 文喟傲卿＆誌謄蜂直埖小 */
	ITEM_CANMERGEFROM,				/* 能否成为合成源 */
	ITEM_CANMERGETO,				/* 能否成为合成目标 */
	...
	ITEM_PUTTIME,					/*  払通  悸札  小直俔掃筑 */
    ITEM_LEAKLEVEL,                 /*    碪札幅直蛍懆班直俔小  */
	ITEM_MERGEFLG,					/*  逓埓書直俔払通  悸小幅気小 */
