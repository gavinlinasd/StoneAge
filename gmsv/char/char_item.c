...
CasinoMapTable casinomap[MAXCASINOMAPNUM] = 
{
	...
	{ 7003, 19, 15, ROULETTE22, 1, "態徒駄２", 1, 0}, { 7003, 15, 15, ROULETTE24, 1, "態徒駄４", 1, 0},
	{ 7003, 19, 21, ROULETTE27, 1, "態徒駄７", 1, 0}, { 7003, 11, 15, ROULETTE31, 1, "態徒駄１１", 1, 0},
	{ 7003,  9, 15, ROULETTE32, 1, "態徒駄１２", 1, 0}, { 7003, 11, 18, ROULETTE34, 1, "態徒駄１４", 1, 0},
	{ 7003,  9, 18, ROULETTE35, 1, "態徒駄１５", 1, 0}, { 7003, 11, 21, ROULETTE36, 1, "態徒駄１６", 1, 0},
	{ 7003, 19, 18, ROULETTE39, 1, "態徒駄１９", 1, 0}, { 7003, 17, 18, ROULETTE40, 1, "態徒駄２０", 1, 0},
	...
	{ 7003, 14, 24, ROULETTE42, 1, "態徒駄", 1, 0}, { 7003, 13, 24, ROULETTE42, 1, "態徒駄", 1, 0},
	{ 7003, 14, 25, ROULETTE42, 1, "態徒駄", 1, 0}, { 7003, 13, 25, ROULETTE42, 1, "態徒駄", 1, 0},
	...
	{ 7003, 15, 18, ROULETTE45, 1, "態徒(００)", 1, 0},
	...
	for( i = 0 ; i < searchloopcount ; i ++ ){
...
#endif
				snprintf( mesg,sizeof(mesg), "憤資 %s",
						  ITEM_getAppropriateName(contents) );
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
		...
		case 1:
			...
			}
			{
				...
				if( contents == 0 ) {
					...
					snprintf( mesg,sizeof(mesg), "憤資 %d Stone",contents );
				}
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
			if( contents != 0 ){
		...
		case 2:	//宠物
			...
			CHAR_setWorkInt( contents, CHAR_WORKOBJINDEX, -1);
			{
				...
				snprintf( mesg,sizeof(mesg), "憤資 %s", p);
				CHAR_talkToCli(charaindex,-1,mesg,CHAR_COLORWHITE);
			}
			// 矢永玄毛胶匀凶夫弘
			LogPet(
			...
			*objindex = index;
			...
			if( amount >= 100 ){ /* 云嗯毛  中凶夫弘 */
			        LogStone(-1,CHAR_getChar( charaindex, CHAR_NAME ), /* 平乓仿   */
			                 CHAR_getChar( charaindex, CHAR_CDKEY ), /* 住＆闇＆ID */
			                 amount,                                   /* 嗯喊 */
							 CHAR_getInt( charaindex, CHAR_GOLD ),
			                 "Drop(放置金钱)",
			                 CHAR_getInt( charaindex,CHAR_FLOOR),
